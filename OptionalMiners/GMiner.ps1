...
$Uri = "https://nemosminer.com/data/optional/gminer_1_23_minimal_windows64.7z"
$Commands = [PSCustomObject]@{
    ...
    #"beam"         = " --devices $($Config.SelGPUDSTM) --algo 150_5" #Equihash150 (Failing on NH, Devs working on it)
}
